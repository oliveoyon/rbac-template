...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button class="btn btn-primary" id="addGroupBtn"><i class="fas fa-plus"></i> Add Group</button>
    </div>
    ...
    <table class="table table-striped" id="groupsTable">
        ...
        <tbody>
            ...
            <tr id="group-{{ $group->id }}">
                ...
                <td>
                    <button class="btn btn-sm btn-info editBtn" data-id="{{ $group->id }}"><i class="fas fa-edit"></i></button>
                    <button class="btn btn-sm btn-danger deleteBtn" data-id="{{ $group->id }}"><i class="fas fa-trash"></i></button>
                </td>
            </tr>
            @endforeach
        </tbody>
        ...
        .then(data => {
            if(data) {
                ...
                if(id) {
                    ...
                    // add new row
                    document.querySelector('#groupsTable tbody').insertAdjacentHTML('beforeend', rowHtml);
                }
                modal.hide();
