...
.user-card {
    ...
    background-color: rgba(198, 239, 206, 0.5); /* light green transparent */
    cursor: default;
...
.user-card.inactive-card {
    ...
    background-color: rgba(255, 200, 200, 0.3); /* soft red transparent */
}

.card-title {
    font-weight: 700; /* Bold user name */
}
            ...
            <div class="col-md-4 mb-3">
                <div class="card user-card {{ $user->is_active ? 'active-card' : 'inactive-card' }}">
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-outline-success btn-sm">
